using ApiControleJogos.Entities;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace ApiControleJogos.Repositories
{
    public class JogoRepository : IJogoRepository
    {
        private static Dictionary<Guid, Jogo> jogos = new Dictionary<Guid, Jogo>()
        {
            ...
            {Guid.Parse("5e99c84a-108b-4dfa-ab7e-d8b55957a7ec"), new Jogo{ Id = Guid.Parse("5e99c84a-108b-4dfa-ab7e-d8b55957a7ec"), Nome = "Fifa 19", Produtora = "EA", Preco = 180 } },
